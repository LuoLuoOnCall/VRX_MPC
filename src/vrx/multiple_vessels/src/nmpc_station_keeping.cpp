...
void StationKeepingNMPC::set_my_nmpc_solver_for_StationKeeping()
{
    ...
    casadi::SX Xudot = 0, Nvdot = 0.2, Iz = 400, Yvdot = 0;
    casadi::SX Nrdot = 0, xg = 0, Yrdot = 0.2;
    casadi::SX Xu = -51.5870, Xuu = -72.4;
    ...
    casadi::SX Yvv = 0, Yrv = -524.3989, Yvr = -524.3989, Yrr = -1378;
    casadi::SX Nvv = -524.3989, Nrv = -1378, Nvr = -1378, Nrr = 0;
