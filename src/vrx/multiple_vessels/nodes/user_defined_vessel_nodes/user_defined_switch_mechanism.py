...
if __name__ == '__main__':
    ...
    user_defined_vessel_count = int(rospy.get_param("/user_defined_vessel_count")) #rospy.set_param('user_defined_vessel_count', self.number_of_user_defined_vessels )=1
    vesselID_of_udv =  vessel_count+1

    i=1
    while i <= user_defined_vessel_count:
        vessel_objects.append(Switch_Mechanism_And_Trajectory_Tracker(vesselID_of_udv))#only for user_difined_vessel,
        i+=1
        vesselID_of_udv +=1
